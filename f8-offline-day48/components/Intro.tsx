...
const Intro = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center">
        ...
        >
          <Image
            ...
            quality="95"
            priority={true}
            className="h-24 w-24 rounded-full object-cover object-left-top border-[0.35rem] border-white shadow-xl"
          />
        </motion.div>
      </div>
      ...
      <motion.div
        className="flex flex-col sm:flex-row items-center justify-center gap-2 px-4 text-lg font-meidum"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{
          delay: 0.1,
